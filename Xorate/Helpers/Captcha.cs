...
namespace Xorate.Helpers
{
    public static class Captcha
    {
        ...
        {
            string result = context.Session.GetString("CaptchaCode");
            var isValid = userInputCaptcha.Equals(context.Session.GetString("CaptchaCode"), StringComparison.OrdinalIgnoreCase);
        ...
        public static CaptchaResult GenerateCaptchaImage(int width, int height, string captchaCode)
        {
            ...
            {
                Random rand = new Random();
                graph.Clear(Color.FromArgb(250, 249, 255));
